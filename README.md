> [!CAUTION]
> This is an old version of the Project-W frontend that won't receive any updates! Project-W has moved to a mono-repository, [go there](https://github.com/julianfp/project-w) for the current version of the frontend.
